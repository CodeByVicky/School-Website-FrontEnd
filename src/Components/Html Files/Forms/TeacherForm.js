...
function TeacherForm() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://my-school-website.onrender.com/api/createTech', formData)
      .then(response => {
            ...
            <div className="bg-white p-4 p-md-5 rounded shadow-sm">
              <div className="row">
                <div className="col-12">
                  <div className="mb-5">
                    <h2 className="h3">Teacher Registration</h2>
                ...
                <div className="row gy-3 gy-md-4 overflow-hidden">
                  ...
                  <div className="col-4">
                    <label htmlFor="standard" className="form-label">
                      Standart <span className="text-danger">*</span>
                    </label>
                    <input
                      type="text"
                      className="form-control"
